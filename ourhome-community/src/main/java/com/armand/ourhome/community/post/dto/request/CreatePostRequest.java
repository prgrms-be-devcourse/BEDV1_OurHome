...
public class CreatePostRequest {
    ...
    private List<CreateContentRequest> contentList;
    ...
    @Builder
    public CreatePostRequest(Long id, String title, SquareType squareType, ResidentialType residentialType, StyleType styleType, List<CreateContentRequest> contentList, int viewCount, Long userId){
        this.id = id;
        this.title = title;
