...
class PostControllerTest {
    ...
    @BeforeEach
    void setUp(){
        userOfPost = userRepository.saveAndFlush(User.builder()
        ...
        var userSaved = userRepository.findById(userOfPost.getId()).orElseThrow( () -> new RuntimeException("해당 사용자 정보는 존재하지 않습니다."));
