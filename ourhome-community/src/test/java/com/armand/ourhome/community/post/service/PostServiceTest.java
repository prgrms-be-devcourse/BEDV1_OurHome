...
import com.armand.ourhome.community.post.dto.request.ReqTagDto;
...
class PostServiceTest {
    ...
    void findAll(){
        ...
        //When
        Page<ResPostDto> postDtoList = postService.getAll(Pageable.ofSize(5).withPage(0));
    ...
    void getAllByResidentialType(){
        ...
        //When
        Page<ResPostDto> postDtoList = postService.getAllByResidentialType(ResidentialType.APARTMENT, Pageable.ofSize(5).withPage(0));
    ...
    void getAllByPlaceTypeWith2Post2Content(){
        ...
        //When
        Page<ResPostDto> postDtoList = postService.getAllByPlaceType(PlaceType.BATHROOM, Pageable.ofSize(5).withPage(0));
    ...
    void savePost1Content1Tag1(){
        //Given
        var postDto = ReqPostDto.builder()
                .residentialType(ResidentialType.APARTMENT)
                .squareType(SquareType.SIZE_10_PYEONG)
                .styleType(StyleType.ASIAN_STYPE)
                .title("사는 집 입니다.")
                .userId(userId)
                .contentList(List.of(ReqContentDto.builder()
                        ...
                        .placeType(PlaceType.LIVINGROOM)
                        .tags(List.of(ReqTagDto.builder()
                                .name("아파트")
                                .build()))
    ...
    void getOne(){
        ...
        //When
        ResPostDto getOnePost = postService.getOne(postSaved.getId());
    ...
    void update(){
        ...
        var postDtoUpdated = ReqPostDto.builder()
